...
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name anchor anchor
...
# Cloud Run routes traffic to $PORT (default 8080, matching config/puma.rb)
EXPOSE 8080
